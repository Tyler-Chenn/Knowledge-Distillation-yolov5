...
def parse_opt(known=False):
    ...
    # 蒸馏训练参数 _____________________________________________________________________________________________
    parser.add_argument('--distill', type=bool, default=True , help='是否采用知识蒸馏训练')
    parser.add_argument('--t_weights', type=str, default='yolov5l.pt' , help='教师权值文件')
    ...
    parser.add_argument('--a', type=float, default=0.3, help='蒸馏损失占总损失的比率')
    # --------------------------------------------------------------------------------------------------------
